    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                ...
                src: [ '<%= yeoman.app %>/bower_components/es5-shim/es5-shim.js',
                    '<%= yeoman.app %>/bower_components/json3/lib/json3.js' ]
            }
//            generated: {
//                files: [
//                    { dest: '.tmp/concat/scripts/oldieshim.js',
            ...
            generated: {
                files: [
                    { dest: 'dist/styles/vendor.css',
                        src: [ '<%= yeoman.app %>/bower_components/bootstrap/dist/css/bootstrap.css',
                            '<%= yeoman.app %>/bower_components/simple-line-icons/css/simple-line-icons.css' ] },
